...
if ((c.r != b_color.r || c.g != b_color.g || c.b != b_color.b) && (c.r !=
f_color.r || c.g != f_color.g || c.b != f_color.b))
{
...
for (i = 0; i < 20; i += 2)
{
glVertex2f(mat1[i][0], mat1[i][1]+200);
glVertex2f(mat1[i + 1][0], mat1[i + 1][1]+200);
}
glEnd();
glFlush();
}
